...
public class YouTubeConfig {
    ...
    WebClient webClient(OAuth2AuthorizedClientManager clientManager) {
        ...
        return WebClient.builder().baseUrl(YOUTUBE_V3_API).apply(oauth2.oauth2Configuration()).build();
    }

    /*
    The below was missing from the book but was in GitHub thankfully
     */
    @Bean
